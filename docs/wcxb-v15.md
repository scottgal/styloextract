...
Run: 2026-06-21 23:19 UTC | pages=1495 | errors=2 | wall-clock=00:27

| System            |     F1 | Precision | Recall | p50 latency | p99 latency |
|-------------------|-------:|----------:|-------:|------------:|------------:|
| StyloExtract v1.3 | 0.627  | 0.624     | 0.704  | 9 ms       | 97 ms       |
| rs-trafilatura    | 0.859  | 0.863     | 0.890  | -           | -           |
| Trafilatura       | 0.791  | 0.852     | 0.793  | -           | -           |
| Readability       | 0.675  | 0.685     | 0.713  | -           | -           |

With-recall: 58.4% | Without-reject: 84.9%

### F1 by page type

| Page type     | StyloExtract | rs-traf | Trafilatura | Readability |
|---------------|-------------:|--------:|------------:|------------:|
| Article (n=792) |        0.733 |   0.932 |       0.926 |       0.825 |
| Documentation (n=91) |        0.779 |   0.932 |       0.888 |       0.736 |
| Service (n=165) |        0.631 |   0.844 |       0.763 |       0.604 |
| Forum (n=112) |        0.342 |   0.808 |       0.585 |       0.466 |
| Collection (n=117) |        0.390 |   0.716 |       0.553 |       0.445 |
| Listing (n=99) |        0.471 |   0.707 |       0.589 |       0.496 |
| Product (n=119) |        0.434 |   0.641 |       0.567 |       0.407 |
