...
Run: 2026-06-24 22:56 UTC | pages=1495 | errors=2 | wall-clock=00:23

| System            |     F1 | Precision | Recall | p50 latency | p99 latency |
|-------------------|-------:|----------:|-------:|------------:|------------:|
| StyloExtract v1.3 | 0.674  | 0.651     | 0.810  | 8 ms       | 73 ms       |
...
| Collection (n=117) |        0.348 |   0.716 |       0.553 |       0.445 |
| Listing (n=99) |        0.426 |   0.707 |       0.589 |       0.496 |
